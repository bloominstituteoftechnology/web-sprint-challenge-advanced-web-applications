...
Thischallenge allows you to practice the concepts and techniques learned over the past sprint and apply them in a concrete project. This sprint explored **advanced web applications**. During this sprint, you studied **React testing, client-side auth, HTTP methods, and Ziet**. In your challenge this week, you will demonstrate your mastery of these skills by creating **a login page**.
...
a token is used for authentification purposes within an app. For example, you can create a form that requires a log in. Once the user is logged in the token gets created and sent through the server for auth.
