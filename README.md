...
A. A token is used to authenticate users to determine if they are able to retrieve data or not.

2. What steps can you take in your web apps to keep your data secure?

A. The following steps would help ensure that my web apps keep my data secure:
    1. Create a PrivateRoute that can only be reached if a valid token is present
    2. Require an authentication token on the server side
    3. Redirect users back to login if the token isn't present

3. Describe how web servers work.

A. Web servers receive a request for data or web pages from the client and then they authorize or deny the user. They then respond with either the data/web page or an error depending on the authentication.
