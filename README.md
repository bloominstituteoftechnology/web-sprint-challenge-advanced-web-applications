...
The token is used to authenticate the user. They are strings of cryptic text and stored on the client side using localSptrage. The server can read the token and make decisions for data transfer.

2. What steps can you take in your web apps to keep your data secure?
Use a private/protected route.

3. Describe how web servers work.
The basic function of a server is to listen in on a port for incoming network requests. Servers can store and organize information.
