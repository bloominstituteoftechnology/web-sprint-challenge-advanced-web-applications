...
Keep things behind a protected page
3. Describe how web servers work.
Information is sent from the user to the backend. The backend parses the data and sends the needed information back to the user. 
