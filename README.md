...
A token is used to store security data.
2. What steps can you take in your web apps to keep your data secure?
You can use a JWT and Private Routes.
3. Describe how web servers work.
Web servers are just a physical place to store data and the coding to get that data out of storage. 
