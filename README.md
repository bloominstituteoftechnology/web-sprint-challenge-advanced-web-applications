...
1. Explain what a token is used for.
  A token is used for authentication of a user so that certain outcomes are protected.

2. What steps can you take in your web apps to keep your data secure?
You can create private routes for certain pages.

3. Describe how web servers work.
Web servers are typically the computers that store data and code for a website and/ or a program that runs on these computers. 
